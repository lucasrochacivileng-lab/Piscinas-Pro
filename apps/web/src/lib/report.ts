...
export function buildMemoryHtml(
 ...
 <p class="notice">Classificação de uso e faixas resistentes referenciadas à ABNT NBR 6136-1:2026. Para aplicação abaixo do nível do solo, utilizar somente bloco Classe A. Em geometrias escalonadas, a paginação deve ser conferida separadamente por zona e nos encontros de degrau.</p>` : "";
 ...
 <p class="notice">Documento de pré-dimensionamento acadêmico. Degraus, ligações, apoio da prainha, juntas e transições de armaduras exigem revisão e responsabilidade técnica de engenheiro habilitado.</p></body></html>`;
}
