...
export function buildMemoryHtml(
 ...
 <p class="notice">Classificação de uso e faixas resistentes referenciadas à ABNT NBR 6136-1:2026. Para aplicação abaixo do nível do solo, utilizar somente bloco Classe A. Os dados geométricos de catálogo de ${escapeHtml(masonry.family.catalogDocument)} não substituem identificação, certificado, medições e ensaios de aceitação do lote, nem a confirmação de prisma, argamassa e graute.</p>` : "";
