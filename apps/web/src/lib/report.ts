...
<p class="notice">Dados geométricos extraídos de ${escapeHtml(masonry.family.catalogDocument)}. A Classe A (fbk ≥ 8 MPa) é uma triagem conservadora da edição 2016 fornecida, cancelada em 27/02/2026. Revisar pela série ABNT NBR 6136-1:2026 vigente e confirmar identificação, certificado e ensaios do lote, além de prisma, argamassa e graute.</p>` : "";
