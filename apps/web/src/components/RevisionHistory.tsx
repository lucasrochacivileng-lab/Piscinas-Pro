...
export function RevisionHistory({ project, revisions, onOpen }: Props) {
  return <section className="revision-panel"><div className="section-title"><div><p className="eyebrow">Registro imutável</p><h2>Revisões</h2></div><span className="revision-count">{revisions.length}</span></div>
